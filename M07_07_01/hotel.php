        ...
        <div class="card mt-2">
            ...
            <div class="card-body">
                <form action="./php_controllers/Controller.php" method="POST">
                    ...
                    <div class="form-group row">
                        <label for="categoria" class="col-sm-2 col-form-label">Categoria Hotel: </label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="categoria" name="categoria"
                                placeholder="Categoria del Hotel" />
                        </div>
                    </div>
                    ...
                    <div class="float-right">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="submit" class="btn btn-secondary" name="insertHotel">Acceptar</button>
